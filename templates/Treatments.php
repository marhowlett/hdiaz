...
<section id="treatments" class="template-section">

         <div class="contenedor">
                    <h1>Treatments</h1>
                    <p>In our dental center, in the hearth of Mexico, next to one of the most important avenues of the city, our dental specialist offer the same treatments, with the same quality brands and materials used in the US or Canada, for a fraction of the price</p>
    </div>

               
    </section>
<section id="treatments2" class="template-section">

            <div class="grid">

                <div class="col prueba_col">
                    <h2 class="dental">Dental 
<br>
<span>Implants </span> </h2>
...
<span>or six</span> </h2>
            ...
            <div class="grid">
                ...
                <div class="col imp">
                 ...
                 <div class="center"> <a href="https://dentalmexicocity.com/wp-content/uploads/2022/04/HH_Treatments.pdf" class="btn">More Details</a></div>
...
<section id="rege2" class="template-section">
 ...
 <section id="dentur" class="template-section">

            <div class="grid">

                <div class="col prueba_col2">
                    <h2 class="dental">Dentures 
<br>
<span>and removable <br>
prosthesis </span> </h2>
        ...
        <section id="endo" class="template-section">
...
<span>composite"</span> </h2>
    ...
    <section id="composite2" class="template-section">
        ...
        <section id="whitening" class="template-section">

        
                    <h2>Dental <span>whitening</span></h2>
...
<section id="make2" class="template-section">
...
<span>In just 3 simple steps</span> </h2>
    ...
    <section id="card" class="template-section">

            <div class="grid">

                <div class="col fondo">
                    <h2 class="how" >How can I pay?</h2>
...
we accept</span></h2>
                    ...
                    <li ><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/dinero.png" alt="Iconos"> USD in cash </li>
                    <li ><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/tarjeta.png" alt="Iconos"> Debit & Credit Cards </li>
                    <li ><img class="pay" src="<?php echo get_stylesheet_directory_uri(); ?>/img/paypal.png" alt="Iconos"> Paypal </li>
